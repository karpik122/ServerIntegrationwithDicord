...
public class Start extends ListenerAdapter {
    ...
    public void onReady(@NotNull ReadyEvent event) {
        ...
        TextChannel textChannelById = Objects.requireNonNull(
                event.getJDA().getGuildById((String) Objects.requireNonNull(
                config.get("guildID")))).getTextChannelById((String)
        ...
        Objects.requireNonNull(textChannelById).sendMessageEmbeds(embed).queue();
    }
}
